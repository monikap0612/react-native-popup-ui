            ...
            <View style={{ flex: 1, backgroundColor: dark ? '#0E2831' : '#FFF', paddingTop: hp(4.5), paddingBottom: hp(1), paddingHorizontal: wp(5) }}>
                <View style={{ alignItems: 'center' }}>
                    ...
                    <View style={{ marginTop: hp(3) }}>
                        <Image source={require('../../../../assets/images/Intro4.png')} style={{ height: hp(50), width: wp(100) }} resizeMode='contain' />
                    </View>

                    {/* <CustomerSupport style={{ marginTop: hp(3) }} /> */}
                </View>

                <View style={[globalStyle.absoluteContainer, { justifyContent: 'flex-end' }]}>
                    <ImageBackground style={{ height: hp(34), justifyContent: 'flex-end', paddingHorizontal: wp(2), paddingBottom: hp(1) }} resizeMode="stretch" source={getBackgroundImage()}>
                        <View style={{ alignItems: 'center', bottom: hp(12) }}>
                            ...
                            {/* <StatusBarDots length={4} index={3} dark={dark} /> */}
                        </View>
                    </ImageBackground>
                </View>
