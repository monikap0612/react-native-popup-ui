...
const IntroFirst = (props) => {
    ...
    const handleSwipeLeft = () => {
        // props.navigation.navigate('IntroSecond')
    }
            ...
            <View style={{ flex: 1, backgroundColor: dark ? '#0E2831' : '#FFF', paddingTop: hp(4.5), paddingBottom: hp(1), paddingHorizontal: wp(5) }}>
                <View style={{ alignItems: 'center' }}>
                    ...
                    <View style={{ marginTop: hp(3) }}>
                        <Image source={require('../../../../assets/images/Intro1.png')} style={{ height: hp(50), width: wp(100) }} resizeMode='contain' />
                    </View>
                    {/* <Thinking style={{ marginTop: hp(3) }} /> */}
                </View>

                <View style={[globalStyle.absoluteContainer, { justifyContent: 'flex-end' }]}>
                    <ImageBackground style={{ height: hp(29), justifyContent: 'flex-end', paddingHorizontal: wp(2) }} resizeMode="stretch" source={getBackgroundImage()}>
